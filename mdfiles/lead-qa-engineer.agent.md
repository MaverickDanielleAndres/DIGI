...
Your job is to ensure the HRMS system is **complete, correct, and production-standard** — from the database to the UI.
...
## Phase 3 — Critical Test Cases for HRMS
